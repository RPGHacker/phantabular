...
var require_datetime = __commonJS({
  "src/datetime.js"(exports, module) {
...
var require_functions = __commonJS({
  "src/functions.js"(exports, module) {
    var utils = require_utils();
    var functions = (() => {
      "use strict";
      ...
      function base64encode(str) {
        ...
        var btoa = typeof window !== "undefined" ? (
          ...
          return new global.Buffer.from(str2, "binary").toString("base64");
        };
        return btoa(str);
      }
      function base64decode(str) {
        ...
        var atob = typeof window !== "undefined" ? (
          ...
          return new global.Buffer.from(str2, "base64").toString("binary");
        };
        return atob(str);
      }
      ...
      function keys(arg) {
        var result = this.createSequence();
        if (Array.isArray(arg)) {
          var merge2 = /* @__PURE__ */ Object.create(null);
...
var require_signature = __commonJS({
  "src/signature.js"(exports, module) {
    var utils = require_utils();
    var signature = (() => {
      "use strict";
...
var require_jsonata = __commonJS({
  "src/jsonata.js"(exports, module) {
    var datetime = require_datetime();
    var fn = require_functions();
    var utils = require_utils();
