...
// PhanTabular note: Edited to be a relative path to silence Firefox error.
import Dexie from '../../../dist/dexie.mjs';
...
var Typeson = /*@__PURE__*/getDefaultExportFromCjs(typesonExports);
...
var StructuredCloning = /*@__PURE__*/getDefaultExportFromCjs(structuredCloningExports);
...
(function (clarinet) {
		  ...
		  try        { Stream = requireFakeStream().Stream; }
...
var clarinet = /*@__PURE__*/getDefaultExportFromCjs(clarinetExports);
